...
public class Gyro {
	...
	public IntegrationFilter integration; // changed to IntegrationFilter that
											// implements the interface
											// sampleProvider
	public LowPassFilter lowPass; // low pass filter for att filtrera gyro
									// signal
	...
	public double EMAOFFSET = 0.0005; //EMAOFFSET 0.00005;
	...
	public synchronized double getAngle() {
		if (firstAng == true) { // kollar time har istallet forsta gangen for
								// att difference skall bli liten
